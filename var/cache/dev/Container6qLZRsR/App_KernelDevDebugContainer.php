...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\MovieDetailsController' => 'getMovieDetailsControllerService',
            'App\\Controller\\MoviesListController' => 'getMoviesListControllerService',
            'App\\Controller\\MoviesWishlistController' => 'getMoviesWishlistControllerService',
            ...
            'App\\Controller\\SimilarMoviesController' => 'getSimilarMoviesControllerService',
    ...
    protected function getCommentsControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\CommentsController', $this));
    ...
    protected function getIndexControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\IndexController', $this));
    ...
    protected function getLoginControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\LoginController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\MovieDetailsController' shared autowired service.
     *
     * @return \App\Controller\MovieDetailsController
     */
    protected function getMovieDetailsControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/MovieDetailsController.php';

        $this->services['App\\Controller\\MovieDetailsController'] = $instance = new \App\Controller\MovieDetailsController();

        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\MovieDetailsController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\MoviesListController' shared autowired service.
     *
     * @return \App\Controller\MoviesListController
     */
    protected function getMoviesListControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/MoviesListController.php';

        $this->services['App\\Controller\\MoviesListController'] = $instance = new \App\Controller\MoviesListController();

        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\MoviesListController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\MoviesWishlistController' shared autowired service.
     *
     * @return \App\Controller\MoviesWishlistController
     */
    protected function getMoviesWishlistControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/MoviesWishlistController.php';

        $this->services['App\\Controller\\MoviesWishlistController'] = $instance = new \App\Controller\MoviesWishlistController();

        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\MoviesWishlistController', $this));
    ...
    protected function getProfileControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\ProfileController', $this));
    ...
    protected function getRegisterControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\RegisterController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\SimilarMoviesController' shared autowired service.
     *
     * @return \App\Controller\SimilarMoviesController
     */
    protected function getSimilarMoviesControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/SimilarMoviesController.php';

        $this->services['App\\Controller\\SimilarMoviesController'] = $instance = new \App\Controller\SimilarMoviesController();

        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\SimilarMoviesController', $this));
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('snCoGlQekA', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getCache_SystemService()
    {
        ...
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6hf8CSwzUV', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
