...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\LogoutController' => 'getLogoutControllerService',
    ...
    protected function getLogoutControllerService()
    {
        ...
        $this->services['App\\Controller\\LogoutController'] = $instance = new \App\Controller\LogoutController();

        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\LogoutController', $this));
