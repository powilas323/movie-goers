...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\UserManagementController' => 'getUserManagementControllerService',
    ...
    protected function getMovieControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\MovieController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\ReviewsController' shared autowired service.
     *
     * @return \App\Controller\ReviewsController
     */
    protected function getReviewsControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/ReviewsController.php';

        $this->services['App\\Controller\\ReviewsController'] = $instance = new \App\Controller\ReviewsController();

        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\ReviewsController', $this));
     ...
     */
    protected function getUserManagementControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/UserManagementController.php';

        $this->services['App\\Controller\\UserManagementController'] = $instance = new \App\Controller\UserManagementController();

        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\UserManagementController', $this));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => 5432, 'dbname' => 'gers', 'user' => 'root', 'password' => 'gers', 'charset' => 'UTF8', 'driverOptions' => [], 'defaultTableOptions' => []], $a, $c, []);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\CommentsRepository' => ['privates', 'App\\Repository\\CommentsRepository', 'getCommentsRepositoryService', false],
            'App\\Repository\\ReportRepository' => ['privates', 'App\\Repository\\ReportRepository', 'getReportRepositoryService', false],
        ], [
    ...
    protected function getServicesResetterService()
    {
        ...
        return $this->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () {
            ...
            return 0 + (int) (isset($this->services['cache.app'])) + (int) (isset($this->services['cache.system'])) + (int) (false) + (int) (false) + (int) (isset($this->privates['cache.annotations'])) + (int) (false) + (int) (false) + (int) (isset($this->privates['debug.stopwatch'])) + (int) (isset($this->services['event_dispatcher'])) + (int) (isset($this->services['security.token_storage'])) + (int) (false);
        }), ['cache.app' => [0 => 'reset'], 'cache.system' => [0 => 'reset'], 'cache.validator' => [0 => 'reset'], 'cache.serializer' => [0 => 'reset'], 'cache.annotations' => [0 => 'reset'], 'cache.property_info' => [0 => 'reset'], 'cache.messenger.restart_workers_signal' => [0 => 'reset'], 'debug.stopwatch' => [0 => 'reset'], 'debug.event_dispatcher' => [0 => 'reset'], 'security.token_storage' => [0 => 'disableUsageTracking', 1 => 'setToken'], 'cache.security_expression_language' => [0 => 'reset']]);
    }
    ...
    protected function getUserInterfaceService()
    {
        ...
        return $this->privates['.errored..service_locator.RLVVpop.Symfony\\Component\\Security\\Core\\User\\UserInterface'] = new \Symfony\Component\Security\Core\User\UserInterface();
    }
     ...
     */
    protected function getReportRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        ...
        return $this->privates['App\\Repository\\ReportRepository'] = new \App\Repository\ReportRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    protected function getCache_AnnotationsService()
    {
        ...
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('40qcHCL4sl', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
